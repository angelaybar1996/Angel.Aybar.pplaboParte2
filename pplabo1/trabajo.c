 ...
 * \return Retorna 0 (EXITO) -1 (ERROR)
 */
int mostrarTrabajo(eTrabajo* unTrabajo,eAuto autos[],int tamAuto,eServicio servicios[],int tamSer,eMarca marcas[],int tamMar,eColor colores[],int tamCol)
{
    int retorno=-1;
    char descAuto[20];
    ...
    if(unTrabajo!=NULL && unTrabajo->isEmpty==0 && autos!=NULL && tamAuto>=0 && servicios!=NULL && tamSer>=0 && marcas!=NULL && tamMar>=0 && colores!=NULL && tamCol>=0)
    {
        ...
        cargarDescripcionAuto(unTrabajo->idAuto,autos,tamAuto,descAuto);
        retorno=0;
 ...
 * \return Retorna 0 (EXITO) -1 (ERROR)
 */
int mostrarTrabajos(eTrabajo trabajos[],int tamTra,eAuto autos[],int tamAuto,eServicio servicios[],int tamSer,eMarca marcas[],int tamMar,eColor colores[],int tamCol)
{
    int retorno=-1;
 ...
 * \return Retorna 0 (EXITO) -1 (ERROR)
 */
int altaTrabajo(eTrabajo trabajos[],int tamTra,eAuto autos[],int tamAuto,eServicio servicios[],int tamSer,eMarca marcas[],int tamMar,eColor colores[],int tamCol,eCliente clientes[],int tamCli, int* pId)
{
    int retorno=-1;
    int i;
    eTrabajo auxTrabajo;
 ...
 * \return Retorna 0 (EXITO) -1 (ERROR)
 */
int menuModificarTrabajo(eTrabajo trabajos[],int tamTra,eAuto autos[],int tamAuto,eServicio servicios[],int tamSer,eMarca marcas[],int tamMar,eColor colores[],int tamCol,eCliente clientes[],int tamCli, int indice)
{
    int retorno=-1;
    int opcion;
    eTrabajo auxTrabajo;
                             ...
                             "Ingrese opcion:","\nError,opcion no valida\n",1,4,2)==0)
            {
                ...
                switch(opcion)
                {
                    case 1:
                        mostrarAutos(autos,tamAuto,marcas,tamMar,colores,tamCol,clientes,tamCli);
                        if(utn_getNumero(&auxTrabajo.idAuto,"\nIngrese id del auto:",
                                         "\nError,id no valido:",80000,80009,2)==0)
                        {
