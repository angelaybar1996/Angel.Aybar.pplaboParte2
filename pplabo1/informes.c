 ...
 */
int menuInformes(eTrabajo trabajos[],int tamTra,eAuto autos[],int tamAuto,eServicio servicios[],int tamSer,eColor colores[],int tamCol,eMarca marcas[],int tamMar,eCliente clientes[],int tamCli)
{
    int retorno=-1;
    int opcion;
        ...
        do
        {
            if(utn_getNumero(&opcion,
                             "\n\n----------------------------------------\n"
                                               "INFORMES"
                             "\n-------------------------------------------"
                             "\n1.Mostrar autos por color"//listo
                             "\n2.Mostrar autos de una marca seleccionada"//listo
                             "\n3.Mostrar los autos mas viejos"//listo
                             "\n4.Listado de autos separados por marca"//listo
                             "\n5.Cantidad de autos de un color y marca"//listo
                             "\n6.Marcas mas elegidas por los clientes"//listo
                             "\n7.Trabajos realizados a un auto"//listo
                             "\n8.Importe total por los trabajos realizados a un auto"//listo
                             "\n9.Infomar los autos que recibieron un servicio ingresado por el usuario"//listo
                             "\n10.Servicios por fecha"//listo
                             "\n11.Salir\n\n"
                             "Ingrese opcion:","\nError,opcion no valida\n",1,11,2)==0)
            {
                ...
                switch(opcion)
                {
                    ...
                    case 7:
                        system("cls");
                        trabajosAuto(trabajos,tamTra,servicios,tamSer,autos,tamAuto,colores,tamCol,marcas,tamMar,clientes,tamCli);
                        printf("\n\n");
                        system("pause");
                        break;
                    case 8:
                        system("cls");
                        totalTrabajosAuto(trabajos,tamTra,servicios,tamSer,autos,tamAuto,colores,tamCol,marcas,tamMar,clientes,tamCli);
                        printf("\n\n");
                        system("pause");
                        break;
                    case 9:
                    ...
                    case 10:
                        system("cls");
                        listarTotalServiciosFecha(trabajos,tamTra,servicios,tamSer,autos,tamAuto,marcas,tamMar,colores,tamCol);
                        printf("\n\n");
                        system("pause");
                        break;
                }
 ...
 * \return Retorna 0 (EXITO) -1 (ERROR)
 */
int trabajosAuto(eTrabajo trabajos[],int tamTra,eServicio servicios[],int tamSer,eAuto autos[],int tamAuto,eColor colores[],int tamCol,eMarca marcas[],int tamMar,eCliente clientes[],int tamCli)
{
    int retorno=-1;
    int idAuto;
    ...
    if(trabajos!=NULL && tamTra>=0 && servicios!=NULL && tamSer>=0 && autos!=NULL && tamAuto>=0 && colores!=NULL && tamCol>=0  && marcas!=NULL && tamMar>=0 && clientes!=NULL && tamCli>=0)
    {
           ...
           buscarAutoId(autos,tamAuto,idAuto)!=-1)
        {
            printf("\nTrabajos de un Auto");
            printf("\n----------------------------------------------------------------");
            printf("\nId             Patente          Servicio        Fecha      Cliente");
            printf("\n----------------------------------------------------------------");
...
int totalTrabajosAuto(eTrabajo trabajos[],int tamTra,eServicio servicios[],int tamSer,eAuto autos[],int tamAuto,eColor colores[],int tamCol,eMarca marcas[],int tamMar,eCliente clientes[],int tamCli)
{
   int retorno=-1;
   int idAuto;
   float total=0;
