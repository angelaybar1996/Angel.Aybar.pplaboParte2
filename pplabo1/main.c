...
int main(void)
{
    ...
    int decision;
    eAuto auxAuto;
    int flagAuto=1;//RECORDAR CAMBIARLA A CERO SINO LO HARDCODEO
                         ...
                         "Opcion no valida",1,11,3)==0)
        {
            switch(opcion)
            {
                                ...
                                "\nError,la patente no es valida",2)==0)
                        {
                            ...
                            if(auxIndice!=-1 && mostrarAuto(autos[auxIndice], marcas, TAM_MAR, colores, TAM_COL,clientes,TAM_CLI)==0)
                            {
                                                 ...
                                                 "Opcion no valida",1,2,1)==0)
                                {
                                    ...
                                    {
                                        system("cls");
                                        menuModificarAuto(autos,TAM_AUTO,marcas,TAM_MAR,colores,TAM_COL,auxIndice);
                                        system("pause");
                                    }
                                }
                            }
                ...
                case 8:
                    if(flagAuto)
                    {
                        if(altaTrabajo(trabajos,TAM_TRA,autos,TAM_AUTO,servicios,TAM_SER,marcas,TAM_MAR,colores,TAM_COL,clientes,TAM_CLI,&nextTrabajo)==0)
                        {
                            system("cls");
                ...
                case 9:
                    ...
                    {
                         system("cls");
                        mostrarTrabajos(trabajos,TAM_TRA,autos,TAM_AUTO,servicios,TAM_SER,marcas,TAM_MAR,colores,TAM_COL);//bien
                        system("pause");
                    }
                    else
                    {
                ...
                case 10:
                    ...
                    {
                        system("cls");
                        menuInformes(trabajos,TAM_TRA,autos,TAM_AUTO,servicios,TAM_SER,colores,TAM_COL,marcas,TAM_MAR,clientes,TAM_CLI);
                        system("pause");
                    }
                    else
                    {
